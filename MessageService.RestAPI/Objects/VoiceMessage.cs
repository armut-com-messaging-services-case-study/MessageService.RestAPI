using MessageService.RestAPI.Json.Converters;
...
namespace MessageService.RestAPI.Objects
{
    ...
    public class VoiceMessageOptionalArguments
    {
        ...
        public Common.VoiceType Voice { get; set; }
    ...
    public class VoiceMessage : IIdentifiable<string>
    {
        ...
        public string Body
        {
            ...
            set
            {
                // Create const to hold the max length
