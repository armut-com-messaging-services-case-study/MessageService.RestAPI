...
namespace MessageService.RestAPI.Resources
{
    ...
    {
        public static string ConverstationsBaseUrl = "https://localhost:8080/";
        public static string DefaultBaseUrl = "https://localhost:8080/";
        ...
        public MessageService.RestAPI.Objects.IIdentifiable<string> Object { get; protected set; }
        ...
        protected Resource(string name, MessageService.RestAPI.Objects.IIdentifiable<string> attachedObject)
        {
            Name = name;
